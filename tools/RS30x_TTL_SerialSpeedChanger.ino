...
// ■■■■■■■■■■■■■■■ 通 信 速 度 設 定 ■■■■■■■■■■■■■■■
// サーボIDに関係なく速度を変更する
void RS30x_SerialSpeed (unsigned char dat) {
...
void setup() {
  ...
  RS30x_Torque(0xFF, 0x01);         // ID = 1(0x01) , RS30x_Torque = ON   (0x01)
}
