// Meridian_core_for_ESP32_2022.04.14 By Izumi Ninagawa & Meridian Project
// MIT Licenced.
//
...
#define VERSION "Meridian_core_for_ESP32_2022.04.14"
...
void loop()
{
  ...
  if (udp_resv_flag) {//UDP受信完了フラグをチェック(フラグが挙がっていれば UDP受信データ「r_udp_meridim」に中身が入った状態)
    ...
    //s_spi_meridim.bval[177] |= 0B01000000;//meridimの[88]番の14ビット目(ESPのUPD受信成否)のフラグを上げる//★あとで消すテスト用
  }
