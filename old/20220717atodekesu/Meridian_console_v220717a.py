...
# 2022.06.19 サーボと左右、首腰の整合性。L系に首ヨー、R系に腰ヨーが所属するように整理。
# 2022.06.19 Vertuialのチェックボックスをコメントアウト
...
# 100Hz動作でおそらくエラーなし。スキップカウントについてのPC→ESP32の処理がたぶんおかしい。
...
#ROS搭載マシンの場合は、下記の２行をアンコメントアウトしてください。
#import rospy
#from sensor_msgs.msg import JointState

#定数
TITLE_VERSION="Meridian_console_v220717a" #DPGのウィンドウタイトル兼バージョン表示

UDP_RESV_IP="192.168.1.xxxxxxx" #このPCのIPアドレス
UDP_RESV_PORT=22222 #受信ポート

UDP_SEND_IP="192.168.1.xxxxxxxxx" #送信先のESP32のIPアドレス
