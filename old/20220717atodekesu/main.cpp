// Meridian_TWIN_for_ESP32_20220719 By Izumi Ninagawa & Meridian Project
// MIT Licenced.
//
// Meridan TWIN ESP32用スケッチ　20220719版
// スレッド制を見直し, 連続する工程をひとまとまりに.
// UDPの受信待受でループするようにし, タイムアウトも導入.

#define VERSION "Hello, This is Meridian_TWIN_for_ESP32_20220719." // バージョン表示
...
void Wiipad_receive_h()
{
  ...
  if (wiimote.available() > 0)
  {
    ...
    if (JOYPAD_MOUNT == 6)
    {
      ...
      // if (nunchuk.cBtn == 1) pad_btn |= (0b00000100 * 256) + 0b00000000;
      // if (nunchuk.zBtn == 1) pad_btn |= (0x00000001 * 256) + 0b00000000;
    }
